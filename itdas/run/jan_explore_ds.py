...
f1 = open('umbmid/fd_data_s11_adi.pickle', 'rb')
f2 = open('umbmid/md_list_s11_adi.pickle', 'rb')
...
print("Metadata for scan of interest: ", u_meta_data[5])
...
with open('./scan_112.pickle', 'wb') as handle:
      pickle.dump(td_i_data, handle, protocol=pickle.HIGHEST_PROTOCOL)


# put all gen 2 clean scan data into a .csv file
# df = pd.DataFrame(itdas_md)
# df.to_csv('itdas_md.csv')